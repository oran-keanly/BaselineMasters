...
refPose = readmatrix("f1_aut_wide_centerline_oran.csv");
...
%gradbp = linspace(0,totalDistance,131); % Linearize distance
gradbp = linspace(0,totalDistance,197); % Linearize distance
